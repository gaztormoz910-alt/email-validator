...
class TestNames(unittest.TestCase):
    ...
    def test_names_slavic_surname_is_kept_whole(self):
        self.assertEqual(self.ex.extract_name("kovbinbogdan1@gmail.com"),
                         "Kovbin Bogdan",
                         "фамилия снова разваливается на обломки")

    def test_names_surname_with_initial(self):
        self.assertEqual(self.ex.extract_name("kovbinb@gmail.com"), "Kovbin B")
    ...
    def test_names_repair_helper_is_index_aware(self):
        ...
        repaired = self.ex._repair_oversegmentation(["kov", "bin", "bogdan"])
        self.assertEqual(repaired, ["kovbin", "bogdan"])
