...
#   "mx.google.com at your service, [203.0.113.7]"
# (адрес из диапазона для документации, RFC 5737: настоящий выходной IP в
# открытом исходнике — это IP того, кто проверял)
