...
# максимум нельзя: Ivan даёт Italy 0.235 при Mexico 0.135 и Spain 0.131,
# Bogdan — Italy 0.306 при Poland 0.284. Это не знание, а шум. Берём ответ,
# только если он и крупный сам по себе, и заметно оторвался от второго места.
NAME_COUNTRY_MIN_SHARE = 0.5
