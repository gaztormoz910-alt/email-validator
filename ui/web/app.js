...
/* Подпись под переключателем «Страна».
...
const COUNTRY_HINT = {
  accuracy: "заполнено реже, но вернее: слабое распределение отбрасывается",
  coverage: "заполнено почти всегда, ~треть стран — догадка",
};
